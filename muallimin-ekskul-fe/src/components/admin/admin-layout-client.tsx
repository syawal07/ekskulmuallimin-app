      ...
      >
        ...
        <div className="p-4 border-t border-slate-50 bg-slate-50/50 m-4 rounded-2xl shrink-0">
          ...
          <button 
             ...
             disabled={isPending}
             className="w-full h-9 flex items-center justify-center gap-2 text-xs font-bold text-white bg-red-500 hover:bg-red-600 rounded-md shadow-md shadow-red-500/20 transition-all active:scale-95 disabled:opacity-70 disabled:active:scale-100"
           >
             {isPending ? (
