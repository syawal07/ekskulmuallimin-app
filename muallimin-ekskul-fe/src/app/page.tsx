...
{/* SECTION STATS DAN ABOUT TIDAK PERLU DIUBAH KARENA TIDAK ADA GAMBAR URL DATABASE YANG BERBENTUK KOMPONEN NEXT/IMAGE */}
    ...
    <div className="grid md:grid-cols-3 gap-12 mb-12 border-b border-slate-800 pb-12">
      ...
      <div className="space-y-6">
        ...
        <p className="text-slate-400 leading-relaxed max-w-sm text-sm">
          <strong>{profile?.school_name || "Madrasah Mu'allimin"}</strong> <br/>
      ...
      <div>
        ...
        <ul className="space-y-3 text-sm font-medium">
          ...
          {profile?.website && (
            <li>
              <Link href={profile.website.startsWith('http') ? profile.website : `https://${profile.website}`} target="_blank" className="flex items-center gap-2 hover:text-emerald-400 transition-colors">
