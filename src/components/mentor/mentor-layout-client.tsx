      ...
      >
        ...
        <div className="p-4 border-t border-slate-50 bg-slate-50/50 m-4 rounded-2xl">
          ...
          <button 
             ...
             className="w-full h-9 flex items-center justify-center gap-2 text-xs font-bold text-red-600 border border-red-200 hover:bg-red-50 rounded-md transition-all"
           >
